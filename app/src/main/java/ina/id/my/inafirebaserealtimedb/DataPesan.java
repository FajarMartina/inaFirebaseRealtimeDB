...
import ina.id.my.inafirebaserealtimedb.Adapter.AdapterBarangRecyclerView;
import ina.id.my.inafirebaserealtimedb.model.Barang;
import java.util.ArrayList;
public class DataPesan extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        database.child("barang").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                 ...
                 */
                adapter = new AdapterBarangRecyclerView(daftarBarang, DataPesan.this);
    ...
    public static Intent getActIntent(Activity activity){
        return new Intent(activity, DataPesan.class);
    }
        ...
        if(database!=null){
            database.child("barang").child(barang.getKey()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    Toast.makeText(DataPesan.this,"success delete", Toast.LENGTH_LONG).show();
                }
            });
