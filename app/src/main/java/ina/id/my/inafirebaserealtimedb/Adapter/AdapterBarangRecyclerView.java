package ina.id.my.inafirebaserealtimedb.Adapter;
...
import ina.id.my.inafirebaserealtimedb.DataPesan;
import ina.id.my.inafirebaserealtimedb.FirebaseDBReadSingleActivity;
import ina.id.my.inafirebaserealtimedb.R;
import ina.id.my.inafirebaserealtimedb.model.Barang;
import ina.id.my.inafirebaserealtimedb.Pesan;
            ...
            public boolean onLongClick(View view) {
                ...
                editButton.setOnClickListener(
                        new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                dialog.dismiss();
                                context.startActivity(Pesan.getActIntent((Activity) context).putExtra("data", daftarBarang.get(position)));
                            }
                        }
                );
